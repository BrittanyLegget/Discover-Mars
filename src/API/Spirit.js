 ...
 *     Photos by camera / sol available here : https://api.nasa.gov/mars-photos/api/v1/rovers/spirit/photos?api_key=DEMO_KEY&earth_date=<date>
...
function Spirit() {
      ...
      <>
        <div style={{ paddingTop: "20px", marginBottom: "-10px" }}>
          ...
          <p className="pers-info-paragraph">
            The Spirit Rover has 6 cameras to choose from:{" "}
          </p>
        </div>
        <div>
  ...
  function FormatImages() {
    return (
      <>
        <Container fluid>
          <h1 className="pers-title">Spirit Rover Data</h1>
          <Row>
  ...
  return (
    <div className="page-background">
      <Container fluid>
        <Row xs={1} md={2}>
          <Col>
            {isError && <p>Error fetching Spirit images</p>}
